...
class Servidor:
    ...
    def aceptar_clientes(self) -> None:
        ...
        while True:
            ...
            self.clientes[id_cliente] = (cliente_socket,addr)
    ...
    def desconectar_cliente(self, id_cliente: int) -> None:
        ...
        '''
        # TODO: Parte I
        cliente_socket, addr = self.clientes[id_cliente]
    ...
    def recibir_mensaje(self, id_cliente: int) -> Mensaje:
        ...
        # TODO: Parte II
        cliente_socket, addr = self.clientes[id_cliente]
        mensaje = (cliente_socket).recv(8001)
    ...
    def enviar_mensaje(self, id_cliente: int, mensaje: Mensaje) -> bytes:
        ...
        # TODO: Parte II
        cliente_socket, addr = self.clientes[id_cliente]
        cifrado = pickle.dumps(mensaje)
        cliente_socket.sendall(cifrado)
        cliente_socket.close()
        return cifrado
